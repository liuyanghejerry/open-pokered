...
OUT=Path('/tmp/pokered-completion-20260907-ether-field-repro')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m137-lance-won.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m137-lance-won.script_flags.json',OUT/'bin/pokered.script_flags.json')
