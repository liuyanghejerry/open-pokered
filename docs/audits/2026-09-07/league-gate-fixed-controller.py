...
OUT=Path('/tmp/pokered-completion-20260907-league-gate-fixed')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m96-league-gate-blocked.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m96-league-gate-blocked.script_flags.json',OUT/'bin/pokered.script_flags.json')
