...
OUT=Path('/tmp/pokered-completion-20260907-bruno-gate-repro2')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m129-bruno-blocked.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m129-bruno-blocked.script_flags.json',OUT/'bin/pokered.script_flags.json')
