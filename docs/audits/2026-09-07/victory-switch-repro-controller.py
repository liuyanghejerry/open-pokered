...
OUT=Path('/tmp/pokered-completion-20260907-victory-switch-repro')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m103-victory-road-boulder-ready.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m103-victory-road-boulder-ready.script_flags.json',OUT/'bin/pokered.script_flags.json')
