...
OUT=Path('/tmp/pokered-completion-20260907-victory-hole-fixed')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m114-victory-road-hole-retry.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m114-victory-road-hole-retry.script_flags.json',OUT/'bin/pokered.script_flags.json')
