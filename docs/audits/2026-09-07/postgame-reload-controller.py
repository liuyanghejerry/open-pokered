...
OUT=Path('/tmp/pokered-completion-20260907-postgame-reload')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m154-auto-saved.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m154-auto-saved.script_flags.json',OUT/'bin/pokered.script_flags.json')
