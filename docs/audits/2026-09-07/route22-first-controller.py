...
OUT=Path('/tmp/pokered-completion-20260907-league')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m93-league-supplied.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m93-league-supplied.script_flags.json',OUT/'bin/pokered.script_flags.json')
