...
OUT=Path('/tmp/pokered-completion-20260907-mansion-continue-fixed')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m75-mansion-statue-blocked.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m75-mansion-statue-blocked.script_flags.json',OUT/'bin/pokered.script_flags.json')
