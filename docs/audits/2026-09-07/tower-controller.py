...
OUT=Path('/tmp/pokered-completion-20260907-tower')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m32-tower-ready.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m32-tower-ready.script_flags.json',OUT/'bin/pokered.script_flags.json')
