...
OUT=Path('/tmp/pokered-completion-20260907-route22-stage-repro')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m94-route22-rival-ready.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m94-route22-rival-ready.script_flags.json',OUT/'bin/pokered.script_flags.json')
