...
OUT=Path('/tmp/pokered-completion-20260907-silph-retry')
...
shutil.copy2(ROOT/'docs/audits/2026-09-07/m58-silph-3f-return-blocked.sav',OUT/'active.sav')
shutil.copy2(ROOT/'docs/audits/2026-09-07/m58-silph-3f-return-blocked.script_flags.json',OUT/'bin/pokered.script_flags.json')
